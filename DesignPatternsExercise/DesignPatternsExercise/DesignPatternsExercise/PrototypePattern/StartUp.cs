namespace DesignPatternsExercise.PrototypePattern
{
    ...
    public class StartUp
    {
        public static void Main(string[] args)
        {
            ...
            sandwichMenu["Turkey"] = new Sandwich("Rey", "Turkey", "Swiss", "Lettuce, Onion, Tomato");

            //Deli manager add custom sandwiches
            sandwichMenu["LoadedBLT"] = new Sandwich("Wheat", "Turkey, Bacon", "American", "Lettuce, Tomato, Onion, Olives");
            sandwichMenu["ThreeMeatCombo"] = new Sandwich("Rey", "Turkey, Ham, Salami", "Provolone", "Lettuce, Onion");
